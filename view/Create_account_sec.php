            ...
            <div class="col-lg-8 col-xl-6">
                <div class="card rounded-3">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="../backend/store_contact_sec.php" method="Post" id="contact_form_sec" class="px-md-2">

                            <div class="form-outline mb-4">
                                <label class="form-label bold" for="first_name">Name <span class="error">*</span></label>
